...
- I used multiple rows of flex layed out buttons for the button. You could do it all in one button using the `flex-wrap` property.
...
- You can add a class to get the orange buttons. Or you could try `:last-child` (assuming you have row button.)
